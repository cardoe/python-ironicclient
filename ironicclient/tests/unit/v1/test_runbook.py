...
class RunbookManagerTest(testtools.TestCase):
    ...
    def test_runbook_get_traits(self):
    ...
    def test_runbook_add_trait(self):
        trait = 'CUSTOM_FOO'
    ...
    def test_runbook_remove_all_traits(self):
    ...
    def test_runbook_remove_trait(self):
        trait = 'CUSTOM_FOO'
    ...
    def test_runbook_get_traits_old_api_version(self):
        ...
        self.assertRaises(UnsupportedVersion, self.mgr.get_traits, RUNBOOK['uuid'])

    def test_runbook_add_trait_old_api_version(self):
        # Test with API version that doesn't support traits
        self.api.os_ironic_api_version = "1.111"
        trait = 'CUSTOM_FOO'
        from ironicclient.common.apiclient.exceptions import UnsupportedVersion
        self.assertRaises(UnsupportedVersion, self.mgr.add_trait, RUNBOOK['uuid'], trait)
