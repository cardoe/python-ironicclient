...
class TestListTraitsRunbook(TestBaremetalRunbook):
    ...
    def test_baremetal_list_runbook_traits(self):
...
class TestAddTraitRunbook(TestBaremetalRunbook):
    ...
    def test_baremetal_runbook_add_trait(self):
    ...
    def test_baremetal_runbook_add_multiple_traits(self):
...
class TestRemoveTraitRunbook(TestBaremetalRunbook):
    def setUp(self):
        ...
        # Get the command object to test
        self.cmd = baremetal_runbook.RemoveTraitBaremetalRunbook(self.app, None)

    def test_baremetal_runbook_remove_trait(self):
        arglist = ['runbook_uuid', 'CUSTOM_FOO']
        verifylist = [('runbook', 'runbook_uuid'), ('traits', ['CUSTOM_FOO'])]
    ...
    def test_baremetal_runbook_remove_multiple_traits(self):
        arglist = ['runbook_uuid', 'CUSTOM_FOO', 'CUSTOM_BAR']
        verifylist = [('runbook', 'runbook_uuid'),
                      ('traits', ['CUSTOM_FOO', 'CUSTOM_BAR'])]
    ...
    def test_baremetal_runbook_remove_all_traits(self):
